...
void main(void)
{
    ...
    case 0:
        val = snoise(vec3(coord.x,coord.y,coord.z));
        break;
    case 1:
        val = snoise(vec3(coord.x, coord.y + dim, coord.z));
        break;
    case 2:
        val = snoise(vec3(coord.x + dim, coord.y + dim, coord.z));
        break;
    case 3:
        val = snoise(vec3(coord.x + dim, coord.y, coord.z));
        break;
    case 4:
        val = snoise(vec3(coord.x, coord.y, coord.z + dim));
        break;
    case 5:
        val = snoise(vec3(coord.x, coord.y + dim, coord.z + dim));
        break;
    case 6:
        val = snoise(vec3(coord.x + dim, coord.y + dim, coord.z + dim));
        break;
    case 7:
        val = snoise(vec3(coord.x + dim, coord.y, coord.z + dim));
        break;
    }
